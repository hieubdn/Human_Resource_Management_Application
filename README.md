...
- **Các module**:
  i. **HRM-main**: Module chính quản lý ứng dụng, chứa menu và điều hướng tới các module phụ.
  ii. **Tuyển dụng**: Module phụ để quản lý thông tin tuyển dụng nhân viên.
  iii. **Hồ sơ nhân viên**: Module phụ để quản lý hồ sơ nhân viên.
